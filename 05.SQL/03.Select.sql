 ...
 */
 ...
 select sum(saleprice) from orders where orderid =1;
 --1.4) 박지성이 구매한 도서의 수 (박지성의 고객번호는 1번으로 놓고 작성)
 select count(*) from orders where orderid =1;
 --2.1) 마당서점 도서의 총개수
 ...
 select orderid from orders where orderdate in ('2014-07-04','2014-07-05','2014-07-06','2014-07-07');
 --2.5) 2014년 7월 4일 ~ 7월 7일 사이에 주문 받은 도서를 제외한 도서의 주문번호
 select orderid from orders where orderdate not in ('2014-07-04','2014-07-05','2014-07-06','2014-07-07');
