				...
				<div class="row">
					...
					<div class="col-10">
						<form action="/demo/blog/update" method="post">
							<input type="hidden" name="bid" value="${blog.bid}"><!--아이디값이 보이면 수정될수도 있기때문에 hidden처리한다 -->
							<table class="table table-borderless">
								...
								<tr>
									<td colspan="2" style="text-align: center;">
										...
										<input class="btn btn-secondary" type="reset" value="취소" onclick="location.href='/demo/blog/detail/${blog.bid}'">
									</td>
								</tr>
							</table>
						</form>
